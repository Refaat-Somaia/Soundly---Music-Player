...
class _MainPage extends State<MainPage> with TickerProviderStateMixin {
 ...
 late AnimationController controllerOfList = AnimationController(
  ...
  void updateDuration()async{
    ...
    setState(() {
      progress= assetsAudioPlayer.currentPosition.value.inSeconds/duration1.inSeconds;
    ...
    if(assetsAudioPlayer.current.valueOrNull==null){
        ...
        selectSong(indexOfCurrentSong, false, audiosOfList);
               ...
               else if(shuffle){ int randomNumber = random.nextInt(audiosOfList.length);
       ...
       else if(shuffle){ int randomNumber = random.nextInt(audios.length);
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color:activeDots[0]? mainColor.withOpacity(0.8):secondColor
                            ),
                          ),
                          SizedBox(width: 2.w,),
                           Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color:activeDots[1]? mainColor.withOpacity(0.8):secondColor
                            ),
                          ),
                           SizedBox(width: 2.w,),
                           Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color:activeDots[2]? mainColor.withOpacity(0.8):secondColor
                            ),
                          ),
                             SizedBox(
                            width: 23.w,
                          ...
                          Container(
                              ...
                              child: IconButton(
                                  onPressed: () async{
                                    if(index!=2){
                                    pageController.animateToPage(2, duration: 300.ms, curve: Curves.easeInOut);
  ...
  RegExp regex = RegExp('${searchBar.text}', caseSensitive: false);
...
//   });
                        ...
                        child: Animate(
                            ...
                            children: [
                              ...
                              drawerButton(const Color(0xFF51C4D3), "Theme", () {
                                      ...
                                      return AlertDialog(
                                        ...
                                        actions: <Widget>[
                                          SizedBox(width: 90.w,height: 4.h,),
                                              Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text('Themes',style: setFontStyle(10.sp, FontWeight.bold, fontColor),),
                                SizedBox(width: 2.w,),
                                Icon(CustomIcons.brush,size: 4.h,color: const Color(0xFF51C4D3),)
                              ],
                            ),
                            SizedBox(height: 3.h,),
                                          SizedBox(
                          ...
                          children: [
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                 themeButton("Main", const Color(0xFF7E30E1)),
                               themeButton("Green", const Color(0xFF0EB29A)),
                            ...
                            SizedBox(height: 2.h,),
                              ...
                              :Icons.sunny, 100),
                               ...
                               drawerButton(const Color(0xFF0EB29A), "Create List", () {
        ...
        pageController.animateToPage(1, duration: 400.ms, curve: Curves.easeInOut);
                              ...
                              drawerButton(const Color(0xFFF56D91), "Settings", () {
                                alert(context);
                              },
                                  Icons.settings, 200),
      ...
      child: Column(
            ...
            child: Container(
              ...
              child: Icon(
                ...
                size: 9.h,
                       ...
                       ).animate().fadeIn(duration:playAnimations? 1000.ms:0.ms).shimmer(duration:playAnimations?1000.ms:0.ms,curve: Curves.easeInOut),
        ...
        // track details -----------------------------------------
                  ...
                  SizedBox(
                    ...
                    child: Animate(
                      child: Text(
                          ...
                          style: setFontStyle(13.sp, FontWeight.bold, fontColor)),
                    ).animate().fade(delay:playAnimations?  1500.ms:0.ms),
                  ),
                  SizedBox(height: 3.h,
                    child: Animate(
                      child: Text(nameOfPlayingAlbum,
                          style: setFontStyle(
                              8.sp, FontWeight.bold, fontColor.withOpacity(0.6)),overflow: TextOverflow.ellipsis,),
          ...
          Row(
            ...
            children: [
              ...
              ).animate().slideY(begin: 1,end: 0,curve: Curves.easeInOut,duration: playAnimations? 700.ms:0.ms)
              .fadeIn(curve:Curves.easeInOut,duration: playAnimations? 700.ms:0.ms,delay:playAnimations? 400.ms:0.ms),
              ...
              Animate(
                child: myButton(() {
                  playSong();
                    ...
                    Icon(
                     playingSong? Icons.pause_rounded
                     : 
                     CustomIcons.play,
                      color: mainColor,
                      size:playingSong? 6.h:4.h,
                    )),
              ).animate().slideY(begin: 3,end: 0,curve: Curves.easeInOut,duration:playAnimations? 1200.ms:0.ms)
              .fadeIn(curve:Curves.easeInOut,duration:playAnimations? 1200.ms:0.ms,delay:playAnimations? 500.ms:0.ms),
              Animate(
                child: myButton(
                    () {  
                      setState(() {
              ...
              .fadeIn(curve:Curves.easeInOut,duration:playAnimations? 700.ms:0.ms,delay:playAnimations? 500.ms:0.ms),
            ],
          ),
          SizedBox(
            height: 3.h,
        ...
        // progress bar -------------------------------------------------
              ...
              Animate(
                child: SfSlider(
                      ...
                      //  enableTooltip: true,
                       ...
                       assetsAudioPlayer.seek(Duration(seconds:((duration1.inSeconds)*(progress/85.w)).toInt()));
          ...
          child:Row(
            ...
            children: [
        if(assetsAudioPlayer.currentPosition.hasValue)  Text( "${assetsAudioPlayer.currentPosition.value.toString().split(":")[1]}:${assetsAudioPlayer.currentPosition.value.toString().split(":")[2].substring(0,2)}",
        style: setFontStyle(8.sp, FontWeight.bold, fontColor),),
        SizedBox(width: 50.w,),

         if(assetsAudioPlayer.current.hasValue) Text("${assetsAudioPlayer.current.value?.audio.duration.toString().split(":")[1]}:${assetsAudioPlayer.current.valueOrNull?.audio.duration.toString().split(":")[2].substring(0,2)}",
          style: setFontStyle(8.sp, FontWeight.bold, fontColor),),
          ],
              ...
              Column(
                children: [
                  IconButton(onPressed: (){
                    setState(() {
                      shuffleAnimteDuration==700?shuffleAnimteDuration=701:shuffleAnimteDuration=700;
                      shuffle=!shuffle;
                    });
                    
             
                  }, icon: Icon(CustomIcons.shuffle,size: 4.h,color:shuffle? mainColor:mainColor.withOpacity(0.5),)),
                  Animate(child: 
                  Text(shuffle?"Shuffle on":"Shuffle off",style: setFontStyle(8.sp, FontWeight.bold, fontColor.withOpacity(0.8)),),)
                 .fadeOut(curve: Curves.easeInOut,duration: shuffleAnimteDuration.ms)
                ],
              ),
               Column(
                children: [
                  IconButton(onPressed: (){
                    setState(() {
                      repeatAnimteDuration==700?repeatAnimteDuration=701:repeatAnimteDuration=700;
                      repeat=!repeat;
                    });
                    
             
                  }, icon: Icon(CustomIcons.repeat,size: 4.h,color:repeat? mainColor:mainColor.withOpacity(0.5),)),
                  Animate(child: 
                  Text(repeat?"Loop on":"Loop off",style: setFontStyle(8.sp, FontWeight.bold, fontColor.withOpacity(0.8)),),)
                  .fadeOut(curve: Curves.easeInOut,duration: repeatAnimteDuration.ms)
                ],
              ),
 ...
 SongModel audio=audioList[index];
                ...
                await assetsAudioPlayer.open(
                    Audio.file(uriOfAvtiveSong,
                        ...
                        metas: Metas(
                            ...
                            artist: audio.artist,
                            album: audio.album,
                            image:assetsAudioPlayer.getCurrentAudioImage!=null?  MetasImage.asset(
        ...
        duration1 = assetsAudioPlayer.current.value!.audio.duration;
                  assetsAudioPlayer.seek(Duration(seconds:((duration1.inSeconds)*(progress)).toInt()));
                  assetsAudioPlayer.pause();
   ...
   return  TextButton(
    ...
    onPressed: ()async {
      ...
      setState(() {
       ...
       child: Container(width: 28.w,height: 13.h,decoration: BoxDecoration(
                            color: color,borderRadius: BorderRadius.circular(12)
                          ),child: Center(child: Text(title,style: setFontStyle(12.sp, FontWeight.bold, Colors.white),)),),
 ...
 int index
  ...
  var date = DateTime.fromMillisecondsSinceEpoch(audios[index].duration! );
    ...
    overlayColor: MaterialStateProperty.all(mainColor.withOpacity(0.3))
            ...
            child: Stack(
              ...
              Positioned(
                ...
                bottom: 0,
                child: 
              IconButton(onPressed: (){alertTrackDetails(context, audios[index].title, audios[index].album,
              audios[index].size,audios[index].uri,audios[index].dateAdded,date,audios[index].fileExtension);}
              , icon: Icon(Icons.info_outline_rounded,size: 3.5.h,color: fontColor.withOpacity(0.5),)))
    ...
    Widget createSongOfList(
 int index
 
  ) {
  var date = DateTime.fromMillisecondsSinceEpoch(audiosOfList[index].duration! );
    ...
    overlayColor: MaterialStateProperty.all(mainColor.withOpacity(0.3))
            ...
            child: Stack(
              children: [
                ...
                bottom: 0,
                child: 
              IconButton(onPressed: (){alertTrackDetails(context, audiosOfList[index].title, audiosOfList[index].album,
              audiosOfList[index].size,audiosOfList[index].uri,audiosOfList[index].dateAdded,date,audiosOfList[index].fileExtension);}
              , icon: Icon(Icons.info_outline_rounded,size: 3.5.h,color: fontColor.withOpacity(0.5),)))
        ...
        child: 
            ...
            Stack(
              children: [
               ...
               if(openPlayList)  Animate(
                 child: Container(height: 80.h,width: 100.w,
